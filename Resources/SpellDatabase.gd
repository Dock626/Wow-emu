...
const BuffProcOnTimeOut = preload("res://Resources/Actions/Buffs/Buff_actions/Buff_proc_on_time_out.gd")
...
func _ready():
	Spell_List.append(SpellBuilder.new()
		...
		.add_action(BuffProc.new(400, "Quick_Firebolt", 10))
	...
	Spell_List.append(SpellBuilder.new()
		...
		.add_action(BuffProc.new(20, "Quick_Firebolt", 10))
	...
	Spell_List.append(SpellBuilder.new()
		.create()
		.set_name("Combustion")
		.set_description("Expand your fire ability")
		.set_energy_cost(15)
		.set_cooldown(60)
		.set_cast_time(0)
		.is_GCD(false)
